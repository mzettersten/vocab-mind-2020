...
(function($) {
 jsPsych.instructions = (function() {
                         ...
                         trials[0] = {};
                         trials[0].size = params.size;
                         trials[0].gif = params.gif;
                         ...
                         display_element.animate({'height': trial.size},0);
                         
                         display_element.html(trial.pages[current_page]);
                         
                         if(current_page == 0 && trial.gif == "Bongard"){
                         display_element.append($('<img>', {"src": "lib/images/Bongard.png",
                                                  "id": "Bongard",
                                                  }).width(400).height(275));
                         
                         }
                         
                         if(current_page == 1 && trial.gif == "Bongard"){
                         display_element.append($('<img>', {"src": "lib/images/Bongard.png",
                                                  "id": "Bongard2",
                                                  }).width(400).height(275));
                         ...
                         if(current_page == 0 && trial.gif == "Shark"){
                         display_element.append($('<img>', {"src": "lib/images/Shark.gif",
                                                  "class": "Shark",
                         ...
                         if(current_page == 3){
                         display_element.append($('<img>', {"src": "lib/images/Prince.gif",
                                                  "class": "Prince",
                                                  }).width(350).height(350));
                         ...
                         if(current_page == 3){
                         display_element.animate({'height': '175px'}, 100);
